...
add wave -noupdate -radix decimal /pqc_accelerator_top/PE_CHAIN/PE_0/MULT/C
add wave -noupdate -radix decimal -childformat {{/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(0) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(1) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(2) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(3) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(4) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(5) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(6) -radix decimal} {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(7) -radix decimal}} -subitemconfig {/pqc_accelerator_top/PE_CHAIN/PE_0/C_out(0) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(1) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(2) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(3) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(4) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(5) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(6) {-height 15 -radix decimal} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out(7) {-height 15 -radix decimal}} /pqc_accelerator_top/PE_CHAIN/PE_0/C_out
...
add wave -noupdate -radix decimal /pqc_accelerator_top/PE_CHAIN/PE_GEN(1)/PE/MULT/C
...
add wave -noupdate -radix decimal /pqc_accelerator_top/PE_CHAIN/PE_GEN(2)/PE/MULT/C
...
add wave -noupdate -radix decimal /pqc_accelerator_top/PE_CHAIN/PE_N/MULT/C
...
add wave -noupdate -radix decimal /pqc_accelerator_top/PE_ACCUM/D_in
...
add wave -noupdate -radix decimal -childformat {{/pqc_accelerator_top/C_out(7) -radix decimal} {/pqc_accelerator_top/C_out(6) -radix decimal} {/pqc_accelerator_top/C_out(5) -radix decimal} {/pqc_accelerator_top/C_out(4) -radix decimal} {/pqc_accelerator_top/C_out(3) -radix decimal} {/pqc_accelerator_top/C_out(2) -radix decimal} {/pqc_accelerator_top/C_out(1) -radix decimal} {/pqc_accelerator_top/C_out(0) -radix decimal}} -subitemconfig {/pqc_accelerator_top/C_out(7) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(6) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(5) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(4) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(3) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(2) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(1) {-height 15 -radix decimal} /pqc_accelerator_top/C_out(0) {-height 15 -radix decimal}} /pqc_accelerator_top/C_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {372461 ps} 0}
...
update
WaveRestoreZoom {36986 ps} {555949 ps}
