...
add wave -noupdate -radix decimal /pqc_accelerator_top/DSI/A_LOAD/a_reg_out
...
add wave -noupdate -radix decimal /pqc_accelerator_top/ERR/W
add wave -noupdate /pqc_accelerator_top/ERR/Z
add wave -noupdate -radix decimal /pqc_accelerator_top/ERR/sum_z
add wave -noupdate -radix decimal /pqc_accelerator_top/ERR/sum_e
add wave -noupdate /pqc_accelerator_top/ERR/de
add wave -noupdate -radix decimal /pqc_accelerator_top/ERR/en
add wave -noupdate -divider Outputs
add wave -noupdate -radix decimal /pqc_accelerator_top/C_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {316381 ps} 0}
...
update
WaveRestoreZoom {0 ps} {148684 ps}
