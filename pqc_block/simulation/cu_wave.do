...
add wave -noupdate /control_unit/count
add wave -noupdate /control_unit/count_nxt
add wave -noupdate /control_unit/state
add wave -noupdate /control_unit/state_nxt
add wave -noupdate -divider A_sel
add wave -noupdate /control_unit/count_a_sel
add wave -noupdate /control_unit/count_a_sel_nxt
add wave -noupdate /control_unit/a_sel
add wave -noupdate /control_unit/a_sel_nxt
